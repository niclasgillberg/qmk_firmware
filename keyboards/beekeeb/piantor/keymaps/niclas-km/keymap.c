...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B,                             KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RALT,
                                KC_LGUI, MO(1), KC_LSFT,           KC_SPC, MO(2), KC_BSPC
    ),
    ...
    [2] = LAYOUT_split_3x6_3(
        QK_BOOT, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                                KC_F6,    KC_F7,   KC_F8,  KC_F9,    KC_F10, DF(4),
        KC_TRNS, KC_HOME, KC_PGUP, KC_VOLD, KC_VOLU, KC_MUTE,                              KC_LEFT,  KC_DOWN, KC_UP,  KC_RIGHT, KC_F11, DF(3),
